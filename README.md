...
- API providers support an optional Max Output Tokens setting. When left blank, the default is 16384 tokens; higher thinking levels may use a larger limit. Custom AI automatically retries with `max_completion_tokens` when `max_tokens` is unsupported.
